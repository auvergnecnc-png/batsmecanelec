    ...
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
      ...
      <div className="hidden md:block bg-neutral-900 text-white text-sm">
        <div className="max-w-6xl mx-auto px-4 py-2 flex items-center justify-between">
          ...
          <span>☎️ <a className="underline" href="tel:0687812666">06 87 81 26 66</a> • ✉️ <a className="underline" href="mailto:seb.bats@batsmecanelec.fr">seb.bats@batsmecanelec.fr</a></span>
        </div>
      </div>
      {/* Header */}
